;(function() {
  ...
  var BLOCK_SIZE = 10;
  // this is a way to control how fast the snake moves,
  // making this number smaller results in a faster snake
  var INVERSE_VELOCITY = 300;
  ...
  HeadBlock.prototype = {
    update: function() {
      ...
      if (now > this.lastMove + INVERSE_VELOCITY) {
        this.move();
        this.lastMove = now;
      }
    },
  ...
  window.addEventListener('playsnake', function() {''
    new Game();
  });
})(this);
